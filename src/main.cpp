...
#define APP_ICON_FILE "../thirdparty/fontawesome/solid-900.otf"

int main(int, char **) {
    if (!file_util::exists(APP_ICON_FILE)) {
        std::cerr << "File with icons not found";
        return 1;
    }
    ...
    if (fontAtlas->AddFontFromFileTTF(APP_ICON_FILE, 13.0f, &icons_config, icons_ranges) == nullptr) {
